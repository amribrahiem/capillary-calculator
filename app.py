...
refrigerant = st.selectbox("Select Refrigerant", ["R134a", "R22", "R404A"])
btu_h = st.number_input("System Capacity (Btu/h)", min_value=100, max_value=50000, value=1000, step=50)
